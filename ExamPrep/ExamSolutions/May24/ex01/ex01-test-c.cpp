...
int main() {
    ...
    __02393_placeShip(sea, rows, 1, 8, 2,2,false);
    __02393_placeShip(sea, rows, 2, 5, 3,3,true);
    __02393_placeShip(sea, rows, 3, 7, 4,4,true);
    ...
    cout << endl << "Launching a missile to row 0, column 8..." << 
    toString(launchBigMissile(sea, rows, 0, 8)) << endl;
    cout << endl << "Launching a missile to row 0, column 9..." << 
    toString(launchBigMissile(sea, rows, 0, 9)) << endl;
    
    cout << endl << "Launching a missile to row 1, column 8..." << 
    toString(launchBigMissile(sea, rows, 1, 8)) << endl;
    cout << endl << "Launching a missile to row 2, column 8..." << 
    toString(launchBigMissile(sea, rows, 2, 8)) << endl;

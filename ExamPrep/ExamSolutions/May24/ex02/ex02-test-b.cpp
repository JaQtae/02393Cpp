...
int main() {
    ...
    Song *ps = find(ss, 240);
    cout << "A new playlist containing only songs longer than 240 seconds is : ";
    displayPlaylist(ps);
    cout << endl;

    Song *ds = find(ss, 300);
    cout << "A new playlist containing only songs longer than 300 seconds is : ";
    displayPlaylist(ds);
    cout << endl;

    Song *cs = find(ss, 320);
    cout << "A new playlist containing only songs longer than 320 seconds is : ";
    displayPlaylist(cs);
    cout << endl;
